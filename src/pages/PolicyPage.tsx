...
const SITE_URL = 'https://pavelmalyv.github.io/todo/';
const POLICY_URL = 'https://pavelmalyv.github.io/todo/privacy-policy';
...
const PolicyPage = () => {
	...
	return (
		<section className="section-page" aria-labelledby={titleId}>
			<div className="container">
				<div className="text">
					<h1 id={titleId}> Политика в отношении обработки персональных данных</h1>
					...
					<p>
						...
						по обеспечению безопасности персональных данных, предпринимаемые Малышевым Павлом
					...
					<ol>
						...
						<li>2.10. Пользователь — любой посетитель веб-сайта {SITE_URL}.</li>
						<li>
					...
					<p>
						Цель обработки: предоставление доступа Пользователю к сервисам, информации и/или
						материалам, содержащимся на веб-сайте
					</p>
					<p>Персональные данные: электронный адрес</p>
					<p>
						Правовые основания: Федеральный закон «Об информации, информационных технологиях и о
					...
					<ol>
						...
						<li>
							...
							электронной почты Оператора <Link to={`mailto:${EMAIL}`}>{EMAIL}</Link> с пометкой
						...
						<li>
							...
							<Link to={`mailto:${EMAIL}`}>{EMAIL}</Link> с пометкой «Отзыв согласия на обработку
							персональных данных».
						</li>
						<li>
							8.5. Для технического обеспечения работы сервиса используются сторонние платформы
							(например, Firebase (Google LLC) и другие поставщики услуг). Данные пользователей
							могут передаваться и храниться на серверах, расположенных за пределами Российской
							Федерации. Обработка данных сторонними сервисами регулируется их политиками
							конфиденциальности. Оператор не несет ответственность за действия третьих лиц, в том
					...
					<ol>
						<li>
							...
							электронной почты <Link to={`mailto:${EMAIL}`}>{EMAIL}</Link>.
						</li>
						<li>
